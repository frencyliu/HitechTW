        ...
        <div class="<?php echo $column_classes; ?>">
            <article role="article" id="post-<?php echo $the_post->ID; ?>" class="row <?php echo $output_article_class; ?>">
                ...
                if (strpos($output_hide_elements, 'title')  === false) {
                    echo '<a href="' . get_the_permalink($the_post) . '"><' . $output_heading_tag . ' class="h5 text-gray-800 max-3-line mb-2">' . get_the_title($the_post) . '</' . $output_heading_tag . '></a>';
                }
                ...
                ?>
                <p class="text-gray-600 mb-2"><?php echo $date . ' ' . $author; ?></p>
...
function yc_get_posts_hover_card_view($the_posts, $get_posts_shortcode_atts)
{
    extract($get_posts_shortcode_atts);
    ...
    foreach ($the_posts as $the_post) :
        ...
        get_template_part('loops/hover_card', null, $args);
        $out .= ob_get_clean();
    endforeach;
...
function yc_get_posts_list_view($the_posts, $get_posts_shortcode_atts)
{
    ...
    ?>
        ...
        <div class="<?php echo $column_classes; ?>">
            <article role="article" id="post-<?php echo $the_post->ID; ?>" class="border-bottom border-gray-400 <?php echo $output_article_class; ?>">

                <?php
                if (strpos($output_hide_elements, 'title')  === false) {
                    echo '<a href="' . get_the_permalink($the_post) . '"><' . $output_heading_tag . ' class="h6 text-gray-800 mb-1 max-2-line">' . get_the_title($the_post) . '</' . $output_heading_tag . '></a>';
                }
                ...
                if (!empty($author) || !empty($date)) {
                    echo '<p class="text-gray-600 mb-1r">' . $date . ' ' . $author . '</p>';
                }
                ?>
